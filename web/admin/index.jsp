...
<aside class="Hui-aside">
	...
	<dl id="menu-picture">
		...
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath}/MessageController?op=query" data-title="意见反馈" href="javascript:void(0)">留言列表</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-member">
			<dt><i class="Hui-iconfont">&#xe60d;</i> 普通用户管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="member-list.html" data-title="会员列表" href="${pageContext.request.contextPath}/AdminController?op=query">普通用户列表</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-admin">
