...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="${pageContext.request.contextPath}/AdminController?op=login" method="post">
      <div class="row cl">
...
<div class="footer">Copyright 你的公司名称 by 在线名片设计</div>
